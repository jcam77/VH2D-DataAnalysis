function tests = AuxFcn_LoadExperiment_002(cfg)
...
% UPDATES in _002:
% - Renamed daqData fields: 'name' -> 'fileName' and 'file' -> 'filePath'.
% - Synchronized to call AuxFcn_ReadDAQ_TXT_002 and AuxFcn_ReadTPC5_001.
