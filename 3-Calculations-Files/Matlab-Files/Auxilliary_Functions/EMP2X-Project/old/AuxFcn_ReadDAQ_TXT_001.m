function daqData = AuxFcn_ReadDAQ_TXT_001(fileName, varargin)
% AuxFcn_ReadDAQ_TXT_001
...
%   daq1 = AuxFcn_ReadDAQ_TXT_001('Test_001_DAQ1.txt', ...
...
% - Standardized output fields: 'fileName' (short name) and 'filePath' (absolute path).
...
daqData.fileName = string(fName) + string(fExt); % e.g., "Problem grounding.txt"
