function AuxFcn_SimpleResultsPlot_001(AuxFcn_GS,figName,PlotTitle,Time_LabV,TempResultsData2R,lgd1,lgd2,lgd3,lgd4,lgdAll,Execute)
% AuxFcn_SimpleResultsPlot_001
% Plot multi-dataset calibration/result curves on one figure.
%
% Inputs:
...
switch Execute
    case 'Execute'
        ...
        %% Info & Settings
                ...
                lgd = legend([CalibCurve_1 CalibCurve_2 CalibCurve_3 CalibCurve_4 CalibCurve_All],{lgd1,lgd2,lgd3,lgd4,lgdAll},'Location','SouthEast', 'Interpreter', 'latex');
