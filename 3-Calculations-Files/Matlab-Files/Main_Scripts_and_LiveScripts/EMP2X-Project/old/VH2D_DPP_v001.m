...
disp(rawLoadStatusDisplayTable); %[output:67f541cb]
...
%%
%[text] ## 2. Data Preparation
%[text] ### 1.1 Load Raw Signal Data
% --- Files to load (DAQ1-DBI TXT) ---
...
assert(exist('AuxFcn_LoadExperiment_005','file')==2, 'AuxFcn_LoadExperiment_005 not found on MATLAB path.');
assert(exist('AuxFcn_ReadDAQ_TXT_002','file')==2,     'AuxFcn_ReadDAQ_TXT_002 not found on MATLAB path.');
assert(exist('AuxFcn_ReadDAQ_MF4_001','file')==2,     'AuxFcn_ReadDAQ_MF4_001 not found on MATLAB path.');
assert(exist('AuxFcn_ReadDAQ_CSV_001','file')==2,     'AuxFcn_ReadDAQ_CSV_001 not found on MATLAB path.');

% --- Build cfg (DAQ1-DBI only) ---
cfg = struct();
...
% Identify which stream index corresponds to DAQ1-DBI (assumes consistent cfg.daqs order)
daqsIds = string({tests(1).daqs.id});
kDAQ1 = find(daqsIds == "DAQ1-DBI", 1, 'first');
assert(~isempty(kDAQ1), 'DAQ1-DBI stream not found in tests(1).daqs.');

% Pull DAQ1-DBI data for all tests
selectedDataCell = arrayfun(@(s) s.daqs(kDAQ1).data, tests, 'UniformOutput', false);

validMask = ~cellfun(@isempty, selectedDataCell);
if any(~validMask)
    warning('DAQ1-DBI missing for test indices: %s', mat2str(find(~validMask).'));
end
...
%%
%[text] ### 1.2 Plot Imported Raw Signal Data
%[text] **Objective:** visually screen all tests/channels and highlight known regions of interest (trigger EMI and early-time channel behavior).
%[text] **Workflow:**
%[text] 1. loop through tests and skip those with insufficient channels
%[text] 2. extract first 4 channels and convert pressure channels to kPa
%[text] 3. plot stacked channel subplots with consistent labels/format
%[text] 4. add focused insets for channel-4 EMI and Test-1/channel-1 window \
%[text] **Note:** using subplots for simultaneous visualization of all channels.
%[text] 
t = run_Wk22_02_01.DAQ_1.t;
y = run_Wk22_02_01.DAQ_1.signal(:,1);
run_Wk22_02_01_channels = run_Wk22_02_01.DAQ_1.channels;
run_Wk22_02_01_units = run_Wk22_02_01.DAQ_1.units;
plot(t, y)
AuxFcn_Figure_Settings("Time [s]","OverPressure [bar]","","Test",12)

% xlabel("Time [s]")
% ylabel(run_Wk22_02_01_channels(1) + " [" + run_Wk22_02_01_units(1) + "]")
grid on
hold on
%[text] 
...
%---
%[output:67f541cb]
%   data: {"dataType":"text","outputData":{"text":"          <strong>RunId<\/strong>               <strong>DAQ_System<\/strong>              <strong>Samples<\/strong>               <strong>Channels<\/strong>               <strong>Fs_Hz<\/strong>                         <strong>Status<\/strong>              \n    <strong>__________________<\/strong>    <strong>___________________<\/strong>    <strong>__________________<\/strong>    <strong>__________________<\/strong>    <strong>__________________<\/strong>    <strong>__________________________________<\/strong>\n\n    \"VH2D-Wk22-02-01\"     \"DAQ_1\"                \"2097152\"             \"2\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-02-01\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-02-01\"     \"DAQ_4\"                \"6250000\"             \"2\"                   \"2500000\"             \"loaded\"                          \n    \"VH2D-Wk22-02-01\"     \"H2CM\"                 \"154\"                 \"1\"                   \"0.73202614379\"       \"WARNING_missing_required_channel\"\n    \"VH2D-Wk22-02-01\"     \"Hydrogen_Sensor_1\"    \"191552\"              \"1\"                   \"3.2458640655\"        \"loaded\"                          \n    \"VH2D-Wk22-02-01\"     \"Hydrogen_Sensor_2\"    \"191552\"              \"1\"                   \"3.2458640655\"        \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-02-02\"     \"DAQ_1\"                \"2097152\"             \"2\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-02-02\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-02-02\"     \"DAQ_4\"                \"5250000\"             \"2\"                   \"2500000\"             \"loaded\"                          \n    \"VH2D-Wk22-02-02\"     \"H2CM\"                 \"139\"                 \"1\"                   \"1\"                   \"WARNING_missing_required_channel\"\n    \"VH2D-Wk22-02-02\"     \"Hydrogen_Sensor_1\"    \"3025\"                \"1\"                   \"3.3323409088\"        \"loaded\"                          \n    \"VH2D-Wk22-02-02\"     \"Hydrogen_Sensor_2\"    \"3025\"                \"1\"                   \"3.3318275471\"        \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-02-03\"     \"DAQ_1\"                \"2097152\"             \"2\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-02-03\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-02-03\"     \"DAQ_4\"                \"5250000\"             \"2\"                   \"2500000\"             \"loaded\"                          \n    \"VH2D-Wk22-02-03\"     \"H2CM\"                 \"129\"                 \"1\"                   \"1\"                   \"WARNING_missing_required_channel\"\n    \"VH2D-Wk22-02-03\"     \"Hydrogen_Sensor_1\"    \"2289\"                \"1\"                   \"3.3342562772\"        \"loaded\"                          \n    \"VH2D-Wk22-02-03\"     \"Hydrogen_Sensor_2\"    \"2289\"                \"1\"                   \"3.3342562772\"        \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-02-04\"     \"DAQ_1\"                \"2097152\"             \"2\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-02-04\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-02-04\"     \"DAQ_4\"                \"5250000\"             \"2\"                   \"2500000\"             \"loaded\"                          \n    \"VH2D-Wk22-02-04\"     \"H2CM\"                 \"146\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-02-04\"     \"Hydrogen_Sensor_1\"    \"564\"                 \"1\"                   \"3.3364940145\"        \"loaded\"                          \n    \"VH2D-Wk22-02-04\"     \"Hydrogen_Sensor_2\"    \"564\"                 \"1\"                   \"3.3364940145\"        \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-03-01\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-03-01\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-03-01\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-03-01\"     \"H2CM\"                 \"162\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-03-01\"     \"Hydrogen_Sensor_1\"    \"765\"                 \"1\"                   \"3.335661893\"         \"loaded\"                          \n    \"VH2D-Wk22-03-01\"     \"Hydrogen_Sensor_2\"    \"764\"                 \"1\"                   \"3.335810781\"         \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-03-02\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-03-02\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-03-02\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-03-02\"     \"H2CM\"                 \"144\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-03-02\"     \"Hydrogen_Sensor_1\"    \"2051\"                \"1\"                   \"3.334309229\"         \"loaded\"                          \n    \"VH2D-Wk22-03-02\"     \"Hydrogen_Sensor_2\"    \"2051\"                \"1\"                   \"3.334309229\"         \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-03-03\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-03-03\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-03-03\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-03-03\"     \"H2CM\"                 \"156\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-03-03\"     \"Hydrogen_Sensor_1\"    \"1434\"                \"1\"                   \"3.332325652\"         \"loaded\"                          \n    \"VH2D-Wk22-03-03\"     \"Hydrogen_Sensor_2\"    \"1434\"                \"1\"                   \"3.332325652\"         \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-03-04\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-03-04\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-03-04\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-03-04\"     \"H2CM\"                 \"153\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-03-04\"     \"Hydrogen_Sensor_1\"    \"553\"                 \"1\"                   \"3.33675875\"          \"loaded\"                          \n    \"VH2D-Wk22-03-04\"     \"Hydrogen_Sensor_2\"    \"553\"                 \"1\"                   \"3.33675875\"          \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-03-05\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-03-05\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-03-05\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-03-05\"     \"H2CM\"                 \"133\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-03-05\"     \"Hydrogen_Sensor_1\"    \"546\"                 \"1\"                   \"3.331092232\"         \"loaded\"                          \n    \"VH2D-Wk22-03-05\"     \"Hydrogen_Sensor_2\"    \"546\"                 \"1\"                   \"3.331092232\"         \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-04-01\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-04-01\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-04-01\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-04-01\"     \"H2CM\"                 \"163\"                 \"1\"                   \"1\"                   \"WARNING_missing_required_channel\"\n    \"VH2D-Wk22-04-01\"     \"Hydrogen_Sensor_1\"    \"493\"                 \"1\"                   \"3.337403337\"         \"loaded\"                          \n    \"VH2D-Wk22-04-01\"     \"Hydrogen_Sensor_2\"    \"493\"                 \"1\"                   \"3.337403337\"         \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-04-02\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-04-02\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-04-02\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-04-02\"     \"H2CM\"                 \"121\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-04-02\"     \"Hydrogen_Sensor_1\"    \"588\"                 \"1\"                   \"3.331063443\"         \"loaded\"                          \n    \"VH2D-Wk22-04-02\"     \"Hydrogen_Sensor_2\"    \"588\"                 \"1\"                   \"3.331063443\"         \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-04-03\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-04-03\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-04-03\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-04-03\"     \"H2CM\"                 \"168\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-04-03\"     \"Hydrogen_Sensor_1\"    \"442\"                 \"1\"                   \"3.337874659\"         \"loaded\"                          \n    \"VH2D-Wk22-04-03\"     \"Hydrogen_Sensor_2\"    \"442\"                 \"1\"                   \"3.337874659\"         \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-04-04\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-04-04\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-04-04\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-04-04\"     \"H2CM\"                 \"166\"                 \"1\"                   \"0.7212121212\"        \"loaded\"                          \n    \"VH2D-Wk22-04-04\"     \"Hydrogen_Sensor_1\"    \"732\"                 \"1\"                   \"3.331206708\"         \"loaded\"                          \n    \"VH2D-Wk22-04-04\"     \"Hydrogen_Sensor_2\"    \"732\"                 \"1\"                   \"3.331206708\"         \"loaded\"                          \n    \"----------------\"    \"----------------\"     \"----------------\"    \"----------------\"    \"----------------\"    \"----------------\"                \n    \"VH2D-Wk22-04-05\"     \"DAQ_1\"                \"2097152\"             \"8\"                   \"1000000\"             \"loaded\"                          \n    \"VH2D-Wk22-04-05\"     \"DAQ_2_3\"              \"442000\"              \"5\"                   \"200000\"              \"loaded\"                          \n    \"VH2D-Wk22-04-05\"     \"DAQ_4\"                \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-04-05\"     \"H2CM\"                 \"950\"                 \"1\"                   \"1\"                   \"loaded\"                          \n    \"VH2D-Wk22-04-05\"     \"Hydrogen_Sensor_1\"    \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n    \"VH2D-Wk22-04-05\"     \"Hydrogen_Sensor_2\"    \"0\"                   \"0\"                   <missing>             \"missing_file\"                    \n\n","truncated":false}}
%---
